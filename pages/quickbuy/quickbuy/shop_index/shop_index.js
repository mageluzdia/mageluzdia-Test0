...
Page({
    ...
    onLoad: function(t) {
        ...
        i.setData({
            ...
            for (var r = [], o = 0; o < i.data.main.group.length; o++) if (i.data.main.goodsArr[i.data.main.group[o].type]) for (var s = i.data.main.goodsArr[i.data.main.group[o].type], n = 0; n < s.length; n++) r[s[n].id] = s[n].cartTotal, 
            i.setData({
                numtotal: r
            });
            if (i.data.main.advs) {
